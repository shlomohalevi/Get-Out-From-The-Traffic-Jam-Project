...
namespace ProMaterialCombiner {
	...
	public class MaterialCombiner {
	    ...
	    private Mesh ExtractMesh(Mesh masterMesh, int subMeshToExtract) {
			...
			masterMesh.uv = new Vector2[masterMesh.normals.Length];
			Debug.Log(masterMesh.uv.Length);
			Debug.Log(masterMesh.normals.Length);
			Debug.Log(masterMesh.vertices.Length);
